...
class Course extends Model
{
    ...
    protected $fillable = [
        'user_id','parent_category_id','second_category_id','category_id','title','slug','short_description','description','benefits','requirements','price_plan','price', 'level','sale_price','status','is_presale','launch_at','thumbnail_id',
        'video_src','total_video_time','require_enroll','require_login','total_lectures', 'total_assignments','total_quiz','rating_value','rating_count','five_star_count',
        'four_star_count','three_star_count','two_star_count','one_star_count','is_featured', 'featured_at','is_popular','popular_added_at','last_updated_at','published_at',
        'created_at','updated_at','awarding_body','blended','online','rfee','afee','online_workshops','included','assessment','entry_requirements','duration','progression','y_gain_qualification','meta_title','meta_dis','meta_keywords'
    ];
    ...
    public function course_subjects(){
        return $this->hasMany(course_subjects::class);
    }
