...
function awarding_bodies($body = null){
    $bodies = [
        1 =>'CMI',
        2 => 'QUALIFI',
        3 => 'IBT',
        ...
        6 => 'UCLAN',
        7 => 'Sage Qualifications',
        8 => 'University of Chichester',
        9 => 'Open University of Switzerland',
    ];

    if ($body !== null){
        $body = (int) $body;
        return array_get($bodies, $body);
    }

    return apply_filters('awarding_bodies', $bodies);
}
