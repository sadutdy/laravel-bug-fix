        ...
        <div class="card-body">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                    <input type="text" name="meta_title" class="form-control" id="meta_title" placeholder="Meta Title" value="{{old('meta_title')}}" data-maxlength="120" >
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea name="meta_description" id="meta_description" class="form-control" value="{{old('meta_dis')}}" placeholder="Meta Description"></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea name="meta_keywords" id="meta_keywords" class="form-control" value="{{old('meta_keywords')}}" placeholder="Meta Keywords"></textarea>
                ...
                <div class="form-row my-3">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <p for="awarding_body" class="mr-4">Awarding Body</p>
                            <select name="awarding_body" class="form-control">
                                @foreach(awarding_bodies() as $key => $awarding_body)
                                    <option value="{{$key}}" {{selected(1, $key)}}>{{$awarding_body}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" name="blended" value="blended" checked>
                            <label class="mb-3">Online Learning</label>
                            <input type="checkbox" name="online" value="online" checked>
