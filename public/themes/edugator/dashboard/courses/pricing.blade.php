            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div id="course-pricing-form-wrap">
                    ...
                    <div class="course-pricing-wrap price_plan_paid" id="course-onetime-pricing-wrap" style="display: {{$course->price_plan == 'paid' || old('price_plan') == 'paid' ? 'block' : 'none'}};" >
                        ...
                        <div class="form-group row {{ $errors->has('price') ? ' has-error' : '' }}">
                            <label for="price" class="col-sm-4 col-form-label text-md-right">Registration Fee</label>
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="rfee" class="form-control{{ $errors->has('rfee') ? ' is-invalid' : '' }}" name="rfee" value="{{ $course->rfee }}">
                                </div>

                                @if ($errors->has('rfee'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('rfee') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row {{ $errors->has('price') ? ' has-error' : '' }}">
                            <label for="price" class="col-sm-4 col-form-label text-md-right">Administration Fee</label>
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="afee" class="form-control{{ $errors->has('afee') ? ' is-invalid' : '' }}" name="afee" value="{{ $course->afee }}">
                                </div>

                                @if ($errors->has('afee'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('afee') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
