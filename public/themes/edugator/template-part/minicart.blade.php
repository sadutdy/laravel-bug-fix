...
<a class="nav-link" href="javascript:;" id="miniCartDropDown">
    <div class="text-center">
        <i class="flaticon-shopping-bag" style="color:black"></i>
        @if($cart->count)
                        ...
                        <div class="minicart-course-info flex-grow-1">
                            ...
                            <div class="mini-cart-course-price">
                                ...
                                <div class="price-html-wrap  current-price-left ">
                                 <span class="current-price">£{{$cart_course['price']}}</span>
                                  <span class="old-price"><s>£{{$cart_course['original_price']}}</s></span>
                                  </div>
