...
<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="{{route('leads')}}"><i class="la la-folder"></i> Leads</a>
            </li>
            <li>
                <a href="{{route('agents')}}"><i class="la la-edit"></i> Agents</a>
            </li>
            ...
            <!-- <li> <a href="{{route('create_course')}}"><i class="la la-chalkboard"></i> Create Course</a>  </li> -->
            <li>
                <a href="{{route('units')}}"><i class="la la-edit"></i> Units</a>
            </li>
            <li>
                <a href="{{route('discounts')}}"><i class="la la-edit"></i> Discounts</a>
            </li>
            <li>
